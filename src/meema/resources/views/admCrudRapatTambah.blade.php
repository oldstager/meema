    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
		    ...
		    <br/>
                   ...
                   <form method="post" action="/admin/rapat/simpan">
 
                        {{ csrf_field() }}
 
                        <div class="form-group">
                            <label>Kode Jenis Rapat</label>
                            <input type="text" name="kode_rapat" class="form-control" placeholder="Kode Jenis Rapat">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="nama_rapat" class="form-control" placeholder="Nama Jenis Rapat"></textarea>
